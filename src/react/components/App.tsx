...
console.log(timezonesWithModifiers);
    ...
    return (
        <main className="w-80 h-fit relative bg-gradient-to-t from-black to-green-950 text-white flex flex-col items-center font-code">
            ...
            <select value={selectedTimezone} onChange={handleTimezoneChange} className="text-black m-3 p-1 box-border w-60 mx-auto block focus:outline-none scrollbar-thin scrollbar-thumb-black">
